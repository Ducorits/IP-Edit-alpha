...
# get portal position
execute store result score @s Xpos run data get entity @s Pos[0] 10000
execute store result score @s Ypos run data get entity @s Pos[1] 10000
...
execute store result score destinationZ ip_edit run data get entity @s Pos[2] 10000
...
execute store result entity @s Pos[0] double 0.0001 run scoreboard players get PosX ip_edit
execute store result entity @s Pos[1] double 0.0001 run scoreboard players get PosY ip_edit
execute store result entity @s Pos[2] double 0.0001 run scoreboard players get PosZ ip_edit
