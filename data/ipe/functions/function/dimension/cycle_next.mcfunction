#cycle forward
data modify storage minecraft:ip_edit Dimension.cycle append from storage minecraft:ip_edit Dimension.cycle[0]
data remove storage minecraft:ip_edit Dimension.cycle[0]
...
#update cycle score
scoreboard players add cycle_pos dimension_info 1
