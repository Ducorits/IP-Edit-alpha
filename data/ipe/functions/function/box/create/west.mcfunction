...
execute as @e[tag=box_pos1,limit=1] run data modify entity @s Rotation[0] set value 270f
...
scoreboard players operation %math ip_edit = box_width ip_edit
...
scoreboard players operation %math ip_edit = @e[tag=ipe_this] ipe_box_midX
...
execute as @e[tag=ipe_this] store result entity @s Pos[0] double 0.0001 run scoreboard players get %math ip_edit
...
execute as @e[tag=ipe_this] store result entity @s width double 0.0001 run scoreboard players get box_depth ip_edit
