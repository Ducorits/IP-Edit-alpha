...
execute at @e[tag=endpoint_pos] align xyz run summon minecraft:area_effect_cloud ~.5 ~.5 ~.5 {Duration:2147483647,Particle:"block minecraft:air",Radius:0,Tags:["box_pos2","ipe_box"]}

tag @s add ipe_box2
tag @s add ipe_done


title @s actionbar {"text":"Second Position Set","color":"blue"}