...
execute as @e[tag=box_pos1,limit=1] run data modify entity @s Rotation[0] set value 0f
execute as @e[tag=box_pos1,limit=1] run data modify entity @s Rotation[1] set value -90f
...
scoreboard players operation %math ip_edit = box_height ip_edit
...
scoreboard players operation %math ip_edit = @e[tag=ipe_this] ipe_box_midY
...
execute as @e[tag=ipe_this] store result entity @s Pos[1] double 0.0001 run scoreboard players get %math ip_edit
execute as @e[tag=ipe_this] store result entity @s Pos[2] double 0.0001 run scoreboard players get @s ipe_box_midZ

# update portal dimensions to dimensions it should have
execute as @e[tag=ipe_this] store result entity @s height double 0.0001 run scoreboard players get box_depth ip_edit
