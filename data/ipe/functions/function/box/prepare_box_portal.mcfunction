...
execute as @e[type=immersive_portals:portal,tag=selected] store result score @s Xpos run data get entity @s Pos[0] 10000
execute as @e[type=immersive_portals:portal,tag=selected] store result score @s Ypos run data get entity @s Pos[1] 10000
execute as @e[type=immersive_portals:portal,tag=selected] store result score @s Zpos run data get entity @s Pos[2] 10000
...
execute as @e[tag=midpoint_pos] store result entity @s Pos[0] double 0.0001 run scoreboard players get PosX ip_edit
execute as @e[tag=midpoint_pos] store result entity @s Pos[1] double 0.0001 run scoreboard players get PosY ip_edit
