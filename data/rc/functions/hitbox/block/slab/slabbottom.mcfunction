...
# #execute if score rayX rc_system > @s cor0X if score rayY rc_system > @s cor0Y if score rayZ rc_system > @s cor0Z if score rayX rc_system < @s cor1X if score rayY rc_system < @s cor1Y if score rayZ rc_system < @s cor1Z run tag @s add stop