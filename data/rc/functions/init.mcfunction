...
scoreboard objectives add rc_cont dummy
scoreboard objectives add rc_system dummy

# set constants
scoreboard players set %1000 rc_cont 1000
scoreboard players set %100 rc_cont 100
scoreboard players set %10 rc_cont 10
scoreboard players set %1 rc_cont 1
